...
import { CategoryList, CategoryModel } from "./stores/interface";
import {
  FilterDefaultModel,
  ModalAction,
...
import { columnsCategory } from "./stores/columns";
...
const Category = () => {
  ...
  const [resData, setResData] = useState<CategoryModel | undefined>(undefined);
